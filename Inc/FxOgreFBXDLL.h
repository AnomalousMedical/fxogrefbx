...
namespace FxOgreFBX
{
    ...
    public:
        ...
        static __declspec(dllexport) bool ExportOgreFromFBX(const char* fbxfilename, const char* outmeshfilename, const char *logfilename, const char *animname, const char *frame0name, bool copyUniqueTextures, int bindframe);
        ...
        static __declspec(dllexport) bool AddFBXAnimationToExisting(const char* fbxfilename, const char* skeletonfilename,  const char* meshfilename, const char *logfilename, const char *animname, int start, int stop, float rate);

        // Deletes an Ogre Animation from the existing .SKELETON and .MESH files if the files and animation exist.
        static __declspec(dllexport) bool DeleteOgreAnimation( const char* skeletonfilename,  const char* meshfilename, const char *logfilename, const char *animname);
